...
namespace osu.Game.Resources.Localisation.Web
{
    ...
    {
        private const string prefix = @"osu.Game.Resources.Localisation.Web.ModelValidation";
        ...
        /// "supported g0v0!"
        /// </summary>
        public static LocalisableString UserChangeUsernameSupporterRequiredLinkText => new TranslatableString(getKey(@"user.change_username.supporter_required.link_text"), @"supported g0v0!");
        ...
        /// </summary>
        public static LocalisableString UserReportInTeam => new TranslatableString(getKey(@"user_report.in_team"), @"You're part of the team.");

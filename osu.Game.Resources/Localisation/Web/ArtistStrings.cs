...
namespace osu.Game.Resources.Localisation.Web
{
    public static class ArtistStrings
    {
        ...
        /// <summary>
        /// "Featured Artists on g0v0!"
        /// </summary>
        public static LocalisableString PageDescription => new TranslatableString(getKey(@"page_description"), @"Featured Artists on g0v0!");
        ...
        /// <summary>
        /// "Featured Artists are artists that we are working in collaboration with in order to bring new and original music to g0v0!. These artists and a selection of their tracks have been hand-picked by the g0v0! team as being awesomesauce and suitable for mapping. Some of these Featured Artists have also created exclusive new tracks for use in g0v0!.&lt;br&gt;&lt;br&gt;All tracks in this section are provided as pre-timed .osz files and have been officially licensed for use in g0v0! and g0v0!-related content."
        /// </summary>
        ...
        /// "g0v0! Beatmaps"
        /// </summary>
        public static LocalisableString LinksBeatmaps => new TranslatableString(getKey(@"links.beatmaps"), @"g0v0! Beatmaps");

        /// <summary>
        /// "g0v0! Profile"
        /// </summary>
        public static LocalisableString LinksOsu => new TranslatableString(getKey(@"links.osu"), @"g0v0! Profile");
        ...
        /// "{0} song|{0} songs"
        /// </summary>
        public static LocalisableString SongsCount(int countDelimited) => new PluralisableString(new TranslatableString(getKey(@"songs.count"), @"{0} song|{0} songs", countDelimited), countDelimited, '|');

        /// <summary>
        /// "g0v0! original"
        /// </summary>
        public static LocalisableString SongsOriginal => new TranslatableString(getKey(@"songs.original"), @"g0v0! original");
        ...
        /// "g0v0! original"
        /// </summary>
        public static LocalisableString TracksIndexExclusiveOnlyExclusiveOnly => new TranslatableString(getKey(@"tracks.index.exclusive_only.exclusive_only"), @"g0v0! original");
